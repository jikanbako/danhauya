...
export default function ApprovalsQueuePage() {
  ...
  const title = isProcurement
    ? stage === "processing" ? "Procurement Processing Queue" : stage === "awaiting-vc" ? "Awaiting VC" : stage === "rejected" ? "Rejected Requisitions" : "Procurement Market Survey"
    : "Approvals Queue";
  ...
  const subtitle = isProcurement
    ? stage === "processing"
      ...
      : stage === "awaiting-vc"
        ...
        : stage === "rejected"
          ? "Final VC rejections involving your Procurement work."
    ...
    <div className={styles.wrapper}>
      ...
      {isProcurement && (
        <div className={styles.tabs}>
          ...
          <Link className={stage === "rejected" ? styles.tabActive : styles.tab} href="/approvals?stage=rejected">Rejected</Link>
        </div>
      )}
            ...
            <tbody>
              {requisitions.map((r) => (
                <tr key={r._id}>
                  ...
                  <td><Link href={`/approvals/${r._id}`} className={styles.reviewLink}>{stage === "processing" || stage === "rejected" ? "Open" : stage === "awaiting-vc" ? "View" : "Review"}</Link></td>
                </tr>
              ))}
            </tbody>
          </table>
