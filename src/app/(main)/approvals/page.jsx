...
export default function ApprovalsQueuePage() {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {(isProcurement || canSeeMyDecisions) && (
        <div className={styles.tabs}>
          {isProcurement && stage !== "my-decisions" && (
            <>
          ...
          {canSeeMyDecisions && (
            <>
              <Link className={stage === "my-decisions" && decisionAction === "all" ? styles.tabActive : styles.tab} href="/approvals?stage=my-decisions">My Decisions</Link>
              <Link className={stage === "my-decisions" && decisionAction === "approve" ? styles.tabActive : styles.tab} href="/approvals?stage=my-decisions&action=approve">Approved by Me</Link>
              <Link className={stage === "my-decisions" && decisionAction === "return" ? styles.tabActive : styles.tab} href="/approvals?stage=my-decisions&action=return">Returned by Me</Link>
              <Link className={stage === "my-decisions" && decisionAction === "reject" ? styles.tabActive : styles.tab} href="/approvals?stage=my-decisions&action=reject">Rejected by Me</Link>
            </>
          )}
        </div>
      )}
            ...
            <tbody>
              {requisitions.map((r) => (
                <tr key={r._id}>
                  ...
                  <td><Link href={`/requisitions/${r._id}`} className={styles.reviewLink}>{stage === "my-decisions" ? "View" : stage === "processing" ? "Open" : stage === "awaiting-vc" ? "View" : "Review"}</Link></td>
                </tr>
              ))}
            </tbody>
          </table>
